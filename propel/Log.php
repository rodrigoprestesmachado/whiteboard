<?php
/**
 * $Header: /home/rpm/cvs/Comercial/propel/Log.php,v 1.1 2007/01/03 20:10:15 rpm Exp $
...
class Log
{
                      ...
                      $level = PEAR_LOG_DEBUG)
    {
        ...
        if (class_exists($class)) {
            // removi o & pois uma nova instancia do objeto sempre será nova, nao precisando da referencia
