...
/**
 * This class adds structure of 'permission' table to 'whiteboard' DatabaseMap object.
 *
 *
...
class PermissionMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'src/model/whiteboard.map.PermissionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addForeignPrimaryKey('ROOM_ID', 'RoomId', 'int' , CreoleTypes::INTEGER, 'room', 'ROOM_ID', true, null);
