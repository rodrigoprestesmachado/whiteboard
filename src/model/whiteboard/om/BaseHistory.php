...
include_once 'src/model/whiteboard/HistoryPeer.php';
...
abstract class BaseHistory extends BaseObject  implements Persistent {
	...
	public function setProductionId($v)
	{
		...
		if ($this->production_id !== $v) {
			...
			$this->modifiedColumns[] = HistoryPeer::PRODUCTION_ID;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== $ts) {
			$this->date = $ts;
			$this->modifiedColumns[] = HistoryPeer::DATE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 3; // 3 = HistoryPeer::NUM_COLUMNS - HistoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(HistoryPeer::PRODUCTION_ID)) $criteria->add(HistoryPeer::PRODUCTION_ID, $this->production_id);
		if ($this->isColumnModified(HistoryPeer::DATE)) $criteria->add(HistoryPeer::DATE, $this->date);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(HistoryPeer::USER_ID, $this->user_id);
		$criteria->add(HistoryPeer::PRODUCTION_ID, $this->production_id);
