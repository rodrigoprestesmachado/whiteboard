...
include_once 'src/model/whiteboard/User.php';
...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'src/model/whiteboard.User';
	...
	/** the column name for the ROOMCREATOR field */
	const ROOMCREATOR = 'user.ROOMCREATOR';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Name', 'Email', 'Password', 'Roomcreator', ),
		BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID, UserPeer::NAME, UserPeer::EMAIL, UserPeer::PASSWORD, UserPeer::ROOMCREATOR, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'name', 'email', 'password', 'roomCreator', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Name' => 1, 'Email' => 2, 'Password' => 3, 'Roomcreator' => 4, ),
		BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID => 0, UserPeer::NAME => 1, UserPeer::EMAIL => 2, UserPeer::PASSWORD => 3, UserPeer::ROOMCREATOR => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'roomCreator' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'src/model/whiteboard/map/UserMapBuilder.php';
		return BasePeer::getMapBuilder('src/model/whiteboard.map.UserMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::ROOMCREATOR);
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(UserPeer::USER_ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	require_once 'src/model/whiteboard/map/UserMapBuilder.php';
	Propel::registerMapBuilder('src/model/whiteboard.map.UserMapBuilder');
}
